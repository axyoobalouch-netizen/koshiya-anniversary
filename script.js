document.addEventListener("DOMContentLoaded", () => {
    ...
    document.addEventListener("click", (e) => {
        // Don't explode if clicking on buttons to avoid blocking
    ...
    // Automatic Smart Slideshow Loop (Includes Safe Skipping)
    slideshowImg.addEventListener("error", () => {
        console.warn("Skipping load failure on image path: " + slideshowImg.src);
        showNextImage();
    });
    ...
    function showNextImage() {
        ...
        }, 600); // Gives time for opacity fade out
    }
